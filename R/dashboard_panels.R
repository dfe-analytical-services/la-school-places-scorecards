panel_homepage <- function() {
  tabPanel(
    ...
    br(strong("The scorecard contains a drop-down list allowing you to view 2022/23, 2023/24 or 2024/25 data.
              The contents section below relates to the 2024/25 data, but would be applicable to the 2022/23 or 2023/24 data if all stated dates and SCAP surveys were a year or two years earlier respectively.
              If you have any questions about the content of the 2022/23 or 2023/24 scorecard, please get in touch.")),
    br(),
    div(
      ...
      div(
        ...
        up to 2024/25 and has plans to provide for academic year 2027/28.  This is based on published
           ",
          a(
            href = "https://explore-education-statistics.service.gov.uk/find-statistics/school-capacity",
            "school capacity data"
          ),
          "as collected in the 2025 School Capacity Survey (SCAP25)."
        ),
        p("The measures shown are:"),
        tags$ul(
          tags$li("places already added since the academic year 2009/10;"),
          tags$li(
            "additional places planned to be added up to the 2027/28 academic year; and"
          ),
          tags$li(
            "estimated number of additional places still needed to meet demand in 2027/28,
          ...
          tags$li(
           ...
           mainstream provision between 2009/10, 2014/15 (for secondary), 2018/19 (for primary) and 2025/26; and"
          ),
          tags$li(
            "the percentage of unfilled places in 2024/25, based on reported school
        ...
        tags$ul(
          tags$li(
            "estimated number of additional places still needed to meet demand in 2027/28 (same figure shown in the chart);"
          ),
          tags$li(
            "estimated percentage of spare places in 2027/28. It is common for a local authority to have both a need for additional places and spare capacity, reflecting pockets of localised need for places or pockets of localised spare places;"
          ),
          tags$li(
            "the total amount of ",
            ...
            " allocated to each local authority to create new places from 2011 to 2027; and"
          ),
          tags$li(
            "the anticipated percentage change in pupil numbers in primary or secondary state-funded mainstream provision between 2025/26 and 2027/28."
          )
        ),
        p(
        ...
        p(
          "Local authorities with relatively fewer places still needed are making good progress in delivering the places they anticipate are needed, however there may be good reasons for a local authority showing a significant number of places still needed to be created.
           For example, places from the Department’s centrally funded free schools due to open in September 2027 onwards are not included in the calculations. Projects to add school places would not have been included in these calculations if they were only recently planned and/or confirmed. "
        ),
        p(
        ...
        p(
          "Estimating place pressure in future years relies on the forecasts of pupil numbers made by local authorities, as provided in the annual school capacity survey. The scorecard illustrates the forecasting accuracy of the selected local authority for forecasts made one year ago and provided in SCAP25,
           and three years ago in SCAP23. These pupil forecasts have been compared with pupils on roll from the January 2026 school census numbers to produce a forecast accuracy score for one and three years ahead. A negative forecast accuracy score indicates an underestimation of pupils,
        ...
        p(
          ...
          ". The headline box shows the percentage of applicants, in the local authority, who received an offer of a place in one of their top three preferences for September 2025 and 2026 entry. The adjacent headline box shows the same percentage for England."
        ),
        p(
          "The chart breaks this down further into those who received an offer of their first, second or third preferences for September 2025 and 2026 entry.
        ...
        p(
          ...
          "local authority has added school places, based on the change between the 2023/24",
          " and the 2024/25 published school capacity data and ",
          shinyGovstyle::external_link(
            href = "https://www.gov.uk/government/statistics/state-funded-schools-inspections-and-outcomes-as-at-31-august-2025",
            "published school Ofsted ratings"
          ),
          "."
        ),
        p(
          "The chart shows the number of new places added in the local authority, between May 2024 and May 2025, according to the Ofsted graded judgements on four areas ('Quality of Education', 'Behaviour and Attitudes', 'Personal Development' and 'Leadership and Management') of the school in which they have been added.
          There are 4 possible Ofsted ratings for these areas: Outstanding, Good, Requires Improvement and Inadequate.
           Where the inspection took place before 1 September 2023 the rating for 'Overall Effectiveness' was used in this chart."
        ),
        p(
        ...
        tags$ul(
          ...
          tags$li(
            "the Ofsted ratings used were available at 31 August 2025 and places may have been added before or after that rating was given."
          ),
        ),
        p(
          "In the box above the chart, users can select England or another local authority to view their data in the chart, alongside their chosen local authority. Please note the headline boxes will not change when selecting a local authority to benchmark against."
        ...
        tags$ul(
          tags$li(
            "the progress 8 rating used is for the 2023/24 academic year as it was not possible to calculate Progress 8 for 2024/25 or 2025/26, because there is no KS2 prior attainment to use to calculate progress when relevant cohorts reach the end of KS4,
            as primary tests and assessments were cancelled in academic years 2019/20 and 2020/21 due to COVID-19 disruption (see ",
            shinyGovstyle::external_link(
              href = "https://www.gov.uk/government/publications/progress-8-school-performance-measure/secondary-accountability-measures-2025-guidance-for-maintained-secondary-schools-academies-and-free-schools",
              "Secondary school accountability in 2025: technical guide"
            ),
            " for more information).
            Places may have been added before or after that rating was given."
          )
        ),
        ...
        tags$ul(
          tags$li(
            ...
            "for 2023/24 or 2024/25, as primary tests and assessments were cancelled in academic years 2019/20 and 2020/21 due to COVID-19 disruption (see ",
            shinyGovstyle::external_link(
              href = "https://www.gov.uk/government/publications/primary-school-accountability/primary-school-accountability-in-2025-technical-guide",
        ...
        p(
          "The Capital Spend Survey that replaced the SCAP Capital Spend Data now collects data on project costs, however due to incomplete coverage it has not yet been incorporated into the scorecard. The cost data used in the scorecard remains the Capital Spend Data from SCAP18. This was used in the 2018, 2019, 2021, 2022, 2023 and 2024 scorecards; there has been no change in the sample of projects. As done in 2023, for the 2024 scorecard, the data has been adjusted for inflation (uprated to 1st quarter 2026 prices)."
        ),
        p(strong(
        ...
        p(
          "As coverage and completeness of the Capacity Spend Survey is still improving, the local authority average costs are not shown in the 2025 scorecard. However, you can find details of all the projects included in the Cost metric in the underlying data on explore education statistics if needed."
        ),
        p(
                ...
                gov_main_layout(
                  ...
                  gov_row(
                    column(
                      ...
                      girafeOutput("places_chart", width = "100%", height = "auto"),
                      girafeOutput("places_chart_england", width = "100%", height = "auto")
                    ),
                    column(
                      6,
                      gov_row(
                      ...
                      gov_row(
                        bslib::layout_column_wrap(
                          width = 1 / 2,
                          uiOutput("pupil_growth_10_to_break"),
                          uiOutput(
                      ...
                      gov_row(
                        bslib::layout_column_wrap(
                          width = 1 / 2,
                          uiOutput("pupil_anticipated_growth")
                        )
                      )
                    )
                  ),
                  ...
                  gov_row(
                    bslib::layout_column_wrap(
                      width = 1 / 4,
                      uiOutput("estimated_additional_places"),
                      uiOutput("current_unfilled_places"),
                      uiOutput("estimated_spare_places"),
                      uiOutput("total_funding_box")
                      # uiOutput("quantity.bartext")
                    )
                  ),
                  gov_row(
                  ...
                  gov_row(
                    column(
                      ...
                      column(
                        ...
                        girafeOutput("forecast_1y_bar", width = "100%", height = "auto"),
                        br(),
                      ...
                      column(
                        ...
                        girafeOutput("forecast_3y_bar", width = "100%", height = "auto"),
                        br(),
              ...
              tabPanel(
                ...
                gov_main_layout(
                  ...
                  gov_row(
                    bslib::layout_column_wrap(
                      width = 1 / 4,
                      uiOutput("prefT3_NY_ENG"),
                      uiOutput("prefT3_CY_ENG"),
                      uiOutput("PrefT3_NY_LA"),
                      uiOutput("PrefT3_CY_ENG")
                    )
                  ),
                  gov_row(
                  ...
                  gov_row(
                    ...
                    girafeOutput("preference_p", width = "100%", height = "auto") %>% withSpinner()
                  )
                )
              ),
              tabPanel(
                ...
                gov_main_layout(
                  ...
                  gov_row(
                    bslib::layout_column_wrap(
                      width = 1 / 2,
                      uiOutput("England_GO_places"),
                      uiOutput("LA_GO_places")
                  ...
                  gov_row(
                    bslib::layout_column_wrap(
                      width = 1 / 4,
                      uiOutput("England_GO_places_Ofsted_QE"),
                      uiOutput("England_GO_places_Ofsted_BA"),
                      uiOutput("England_GO_places_Ofsted_PD"),
                      uiOutput("England_GO_places_Ofsted_LM")
                    )
                  ),
                  gov_row(
                    div(style = "height:1rem")
                  ...
                  gov_row(
                    bslib::layout_column_wrap(
                      width = 1 / 4,
                      uiOutput("LA_GO_places_Ofsted_QE"),
                      uiOutput("LA_GO_places_Ofsted_BA"),
                      uiOutput("LA_GO_places_Ofsted_PD"),
                      uiOutput("LA_GO_places_Ofsted_LM")
                    )
                  ),
                  gov_row(
                    div(style = "height:1rem")
                  ...
                  gov_row(
                    column(
                      ...
                      girafeOutput("quality_chart", width = "100%", height = "auto") %>% withSpinner()
                    )
                  ),
                  uiOutput("no_rating_line"),
                  br(),
                  textOutput("quality_note"),
                  br(),
                  textOutput("nca_quality_note")
                )
              ),
              tabPanel(
                value = "cost",
...
panel_technical <- function() {
  tabPanel(
    ...
    bslib::navset_card_tab(
      id = "tabs_tech_notes",
      bslib::nav_panel("Quantity", uiOutput("notesTableQuant")),
      bslib::nav_panel("Pupil forecast accuracy", uiOutput("notesTableforacc")),
      bslib::nav_panel("Preference", uiOutput("notesTablePref")),
      bslib::nav_panel("Quality", uiOutput("notesTableQual")),
      bslib::nav_panel("Cost", value = "cost", uiOutput("notesTableCost"))
    )
  )
}
