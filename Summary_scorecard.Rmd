...
\makebox[0.96\linewidth]{
\begin{tcolorbox}[colback=gssmidblue, 
 leftright skip=0.5cm,
 coltext=white, 
 halign=left, 
 fontupper={\large \bfseries},
 fontlower={\Huge \bfseries},
 sharp corners, 
 colframe=gssmidblue,
 width=0.4\linewidth,
 boxrule=0pt 
...
```{r quantity, echo = FALSE, fig.show="hold", out.width = "50%", out.height = "100%"}
  ...
  ## Estimated spare places
    ...
    # Display value
            x1 <- paste0("Estimated percentage of spare ", str_to_lower(params$input_phase_choice), " places in ", plan_year, ": ", spare_places_per, "%")
...
```{r preference, echo = FALSE, message=FALSE, fig.width = 6, fig.height = 6}
