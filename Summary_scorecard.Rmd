...
growth_perc <- dfScorecardArea %>%
  ...
  textTopLineGrowth <- paste0("Growth in ", str_to_lower(params$input_phase_choice), " pupil numbers 2009/10 to ", next_year, ": ", growth_perc, "%")

textTopLineAnticipatedGrowth <- paste0("Anticipated growth in ", str_to_lower(params$input_phase_choice), " pupil numbers ", next_year," to ", plan_year, ": ", anticipated_growth_perc, "%")
...
`r growth_perc`\%
\tcblower
Growth in `r str_to_lower(params$input_phase_choice)` pupil numbers 2009/10 to `r next_year`
\end{tcolorbox}
...
`r growth_perc`\%
\tcblower
Anticipated growth in `r str_to_lower(params$input_phase_choice)` pupil numbers `r next_year` to `r plan_year`
\end{tcolorbox}
