...
plot_ly(
  ...
  add_trace(y = ~QuanPP, marker = list(color = c("#3182bd")), name = paste0("New places already planned for delivery between ", this_year, " and ", plan_year), text = ~ scales::comma(QuanPP), textposition = "outside", textfont = list(color = "#000"), width = 0.2) %>%
  add_trace(y = ~QuanRP, marker = list(color = c("#6baed6")), name = paste0("Estimated additional places still needed to meet demand in ", plan_year), text = ~ scales::comma(QuanRP), textposition = "outside", textfont = list(color = "#000"), width = 0.2) %>%
  layout(
    yaxis = list(title = ""),
    xaxis = list(title = ""),
    barmode = "bar",
