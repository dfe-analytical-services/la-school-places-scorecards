...
dfTopLine <- data.frame(
  ...
  growth = paste0(growth_perc, "%"),
   anticipatedgrowth = paste0(anticipated_growth_perc, "%"),
  unfilledplaces = paste0(unfilled_places_perc, "%"),
)
colnames(dfTopLine) <- c(
  paste0("Total primary and secondary basic need funding ", funding_year), " ",
  paste0("Current percentage of unfilled places", this_year),
  paste0("Growth in", str_to_lower(params$input_phase_choice), "pupil numbers 2009/10 to ", next_year),
   paste0("Anticipated growth in", str_to_lower(params$input_phase_choice), "pupil numbers", next_year, "to", plan_year)
