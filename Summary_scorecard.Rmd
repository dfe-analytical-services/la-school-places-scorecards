...
summary_stats_1yr <- forecast_summary_stats(dfScorecardsAll,1,
                                            params$input_phase_choice)
summary_stats_3yr <- forecast_summary_stats(dfScorecardsAll,3,
                                            params$input_phase_choice)
...
``` {r forecast7,echo = FALSE, warning = FALSE, message=FALSE, results='asis'}
   ## Forecast accuracy labels 
    ...
    label_desc_1yr <- forecast_accuracy_desclabel(forecast_accuracy_1yr,
    ...
    label_desc_3yr <- forecast_accuracy_desclabel(forecast_accuracy_3yr,
                                                  params$input_la_choice,
                                                  summary_stats_1yr)
     threeyearlabel <-
