...
tabPanel("Accessibility",
         ...
         tags$div(tags$ul(
           ...
           tags$li("Alternative text in interactive charts is limited (although this data is available in csv format)"))),
         h3("Feedback"),
         br("If you have any feedback on how we could further improve the accessibility of this application, please contact us at",
