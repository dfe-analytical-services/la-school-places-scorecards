...
function(request) {
  ...
  navbarPage(
    ...
    br("Use these scorecards to see:"),
    br("•	The challenges local authorities face in making good school places available"),
    br("•	The funding given to local authorities"),
    br("•	Progress local authorities are making in providing school places"),
    br("You can use the school places scorecards to look at the school place situation for England or any individual local authority (in 2019 there is no scorecard for Dorset and Bournemouth, Christchurch and Poole due to their recent boundary changes, although you can find relevant data for these local authorities in the summary data tabs). To do this, use the drop-down option at the top of the scorecard to select the national option or your chosen local authority. The list is arranged with England at the top and local authorities in alphabetical order. You can look at primary or secondary places by using the adjacent drop-down option."),
    ...
    br("The estimated percentage of spare places is also shown in the blue box above the bar chart. It is common for a local authority to have both a need for additional places and spare capacity, reflecting pockets of localised need for places or pockets of localised spare places."),
    br(),
    h4("Forecast Accuracy"),
    br("Estimating place pressure in future years relies upon the forecasts of pupil numbers made by local authorities. We have included two graphics, which illustrate the forecasting accuracy of the selected local authority for forecasts made one and three years ago. The bar shows under forecasts and over forecasts respectively. The bar extends to the position of the local authority’s forecast in the range of all forecasts."),
    br(),
    h4("Preference"),
    br("You can use the scorecard to see how well the chosen local authority is able to meet parents’ school preferences. The scorecard shows the percentage of applicants who received an offer of a place in one of their top three preferences for entry in September 2021, in the local authority. This is presented alongside the same percentage for England."),
    ...
    br(),
    h4("Quality"),
    br("You can check the quality measure to see where the chosen local authority has added school places."),
    br("The bar chart shows the number of new places added in the local authority according to the Ofsted rating of the school in which they have been added. There are 4 possible Ofsted ratings: outstanding, good, requires improvement and inadequate."),
    br("It is important to take care when making comparisons using the quality measure as:"),
    br("•	The starting position for local authorities is different and some have more good or outstanding schools to add places to - which is why we also provide the overall distribution of school places by Ofsted rating in the local authority chosen, and for England"),
    ...
    br("•	We have used the most recent Ofsted rating available at 31 August 2021 and places may have been added before or after that rating was given"),
